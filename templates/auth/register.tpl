            ...
            <div class="card-body p-4 p-md-5">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted small">
                        Join India's premier high-trust credit management club.
                    </p>
                </div>
                ...
                <form method="POST" action="/cred-app/public/register">
                    ...
                    <div class="mb-3">
                        <label for="mobile" class="form-label">
                            <i class="bi bi-telephone-fill text-warning me-1"></i> Mobile Number
                        </label>
                        <input
                            type="text"
                            class="form-control"
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <label for="password" class="form-label">
                                <i class="bi bi-lock-fill text-warning me-1"></i> Password
                            </label>
                            <input
                                type="password"
                                class="form-control"
                        ...
                        <div class="col-md-6">
                            <label for="confirm_password" class="form-label">
                                <i class="bi bi-shield-lock-fill text-warning me-1"></i> Confirm Password
                            </label>
                            <input
                                type="password"
                                class="form-control"
                ...
                <div class="text-center mt-4 pt-3 border-top">
                    <p class="text-muted small mb-0">
                        Already a member?
                        <a href="/cred-app/public/login" class="fw-bold text-decoration-none" style="color: #b45309;">
                            Login Here
                        </a>
                    </p>
                </div>
